...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__analytics__ = __webpack_require__(68);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__detect__ = __webpack_require__(69);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_3__detect__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__component__ = __webpack_require__(70);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_4__component__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__component_record__ = __webpack_require__(71);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_5__component_record__["a"]; });



const FireHelpers = __WEBPACK_IMPORTED_MODULE_0__helpers__;
/* harmony export (immutable) */ __webpack_exports__["d"] = FireHelpers;

const FireStorage = __WEBPACK_IMPORTED_MODULE_1__storage__;
/* unused harmony export FireStorage */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(18);




class SiteHeader extends __WEBPACK_IMPORTED_MODULE_1__common__["a" /* FireComponent */] {
  constructor(id) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SiteHeader;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_polyfills__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__include_site_header_site_header__ = __webpack_require__(30);
// dependencies
...
const onPageReady = () => {
  // init global scripts
  const global = new __WEBPACK_IMPORTED_MODULE_2__global__["a" /* FireGlobal */]();
  global.init();
};

// fire all scripts
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(onPageReady);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js_fn_array_from__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_fn_string_includes__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_fn_string_includes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_core_js_fn_string_includes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_intersection_observer__ = __webpack_require__(63);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lozad__ = __webpack_require__(65);
...
class FireGlobal {
  init() {
    const detect = new __WEBPACK_IMPORTED_MODULE_1__common__["c" /* FireDetect */]();
    detect.setHtmlClasses();

    const observer = __WEBPACK_IMPORTED_MODULE_0_lozad___default()(); // lazy loads elements with default selector: `.lozad`
    observer.observe();

    const componentRecord = new __WEBPACK_IMPORTED_MODULE_1__common__["b" /* FireComponentRecord */]();
    componentRecord.registerAll();
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = FireGlobal;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["unsetTabIndex"] = unsetTabIndex;
/* harmony export (immutable) */ __webpack_exports__["setTabIndex"] = setTabIndex;
/* harmony export (immutable) */ __webpack_exports__["getPageType"] = getPageType;
/* harmony export (immutable) */ __webpack_exports__["lockBody"] = lockBody;
/* harmony export (immutable) */ __webpack_exports__["lockBodyToggle"] = lockBodyToggle;
/* harmony export (immutable) */ __webpack_exports__["capitalizeFirstLetter"] = capitalizeFirstLetter;
/* harmony export (immutable) */ __webpack_exports__["clearFragment"] = clearFragment;
/* harmony export (immutable) */ __webpack_exports__["shuffle"] = shuffle;
/* harmony export (immutable) */ __webpack_exports__["generateUniqueId"] = generateUniqueId;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
...
/* harmony export (immutable) */ __webpack_exports__["breakpoints"] = breakpoints;


const isDesktop = !window.matchMedia(`(max-width: ${breakpoints.md}px)`).matches;
/* harmony export (immutable) */ __webpack_exports__["isDesktop"] = isDesktop;
...
function unsetTabIndex(element) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).attr('tabindex', '');
}
...
function setTabIndex(element, index) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).attr('tabindex', index);
}
...
function lockBodyToggle() {
  const status = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').attr('data-fire-lock-body');
...
/* harmony export (immutable) */ __webpack_exports__["setItem"] = setItem;
...
/* harmony export (immutable) */ __webpack_exports__["key"] = key;
let inMemoryStorage = {};
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FireDetect;
...
class FireComponent {
  constructor(key, id) {
    ...
    this.$component = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`[data-registered="${id}"][data-fire-component="${key}"]`);

    // helper variable to check if the component exists
    this.componentExists = this.$component.length !== 0;
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = FireComponent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__include_site_header_site_header__ = __webpack_require__(30);
 ...
 *
 **/
class FireComponentRecord {
  registerAll() {
    // loop through all components on the page
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-fire-component]').each((index, component) => {
      // get name of component
      const name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(component).data('fire-component');

      // generate a unique ID
      const id = __WEBPACK_IMPORTED_MODULE_1__common__["d" /* FireHelpers */].generateUniqueId();

      // mark as registered
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(component).attr('data-registered', id);

      // register correct component
      switch (name) {
        case 'site-header':
          new __WEBPACK_IMPORTED_MODULE_2__include_site_header_site_header__["a" /* SiteHeader */](id).init();
          break;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FireComponentRecord;
